...
public class LoadBalancerListener {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(loadBalancerInstanceNo, loadBalancerListenerNo, protocolType, port, useHttp2, sslCertificateNo, tlsMinVersionType, loadBalancerRuleNoList);
	}
