...
public class V2ApiTest {
	 ...
	 */
	@Test
	public void getPortForwardingConfigurationListGetTest() throws ApiException, SdkException {
		GetPortForwardingConfigurationListRequest getPortForwardingConfigurationListRequest = null;

		try {
			// Handler Successful response
			ApiResponse<GetPortForwardingConfigurationListResponse> response = api.getPortForwardingConfigurationListGet(getPortForwardingConfigurationListRequest);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getPortForwardingConfigurationListGetGenericTest() throws ApiException, SdkException {
		// path
		...
		try {
			// Handler Successful response
			ApiResponse<byte[]> response = api.getPortForwardingConfigurationListGet(httpHeaders, queryParams, formParams, requestBody);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getPortForwardingConfigurationListPostTest() throws ApiException, SdkException {
		GetPortForwardingConfigurationListRequest getPortForwardingConfigurationListRequest = null;

		try {
			// Handler Successful response
			ApiResponse<GetPortForwardingConfigurationListResponse> response = api.getPortForwardingConfigurationListPost(getPortForwardingConfigurationListRequest);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getPortForwardingConfigurationListPostGenericTest() throws ApiException, SdkException {
		// path
		...
		try {
			// Handler Successful response
			ApiResponse<byte[]> response = api.getPortForwardingConfigurationListPost(httpHeaders, queryParams, formParams, requestBody);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
