...
public class GetPublicIpInstanceListRequest {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(isAssociated, publicIpInstanceNoList, publicIpList, searchFilterName, searchFilterValue, regionNo, zoneNo, pageNo, pageSize, sortedBy, sortingOrder, responseFormatType);
	}
