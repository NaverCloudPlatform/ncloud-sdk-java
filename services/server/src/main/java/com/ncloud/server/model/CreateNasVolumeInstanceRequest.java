...
public class CreateNasVolumeInstanceRequest {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(volumeName, volumeSize, volumeAllotmentProtocolTypeCode, serverInstanceNoList, customIpList, cifsUserName, cifsUserPassword, nasVolumeDescription, regionNo, zoneNo, isReturnProtection, responseFormatType);
	}
