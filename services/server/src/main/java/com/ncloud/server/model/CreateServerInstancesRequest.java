...
public class CreateServerInstancesRequest {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(serverImageProductCode, serverProductCode, memberServerImageNo, serverName, serverDescription, loginKeyName, isProtectServerTermination, serverCreateCount, serverCreateStartNo, feeSystemTypeCode, userData, initScriptNo, zoneNo, accessControlGroupConfigurationNoList, raidTypeName, instanceTagList, isVaccineInstall, blockDevicePartitionList, responseFormatType);
	}
