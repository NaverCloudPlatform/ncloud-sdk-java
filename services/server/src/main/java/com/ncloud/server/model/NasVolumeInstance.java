...
public class NasVolumeInstance {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(nasVolumeInstanceNo, nasVolumeInstanceStatus, nasVolumeInstanceOperation, nasVolumeInstanceStatusName, createDate, nasVolumeInstanceDescription, mountInformation, volumeAllotmentProtocolType, volumeName, volumeTotalSize, volumeSize, snapshotVolumeConfigurationRatio, snapshotVolumeConfigPeriodType, snapshotVolumeConfigDayOfWeekType, snapshotVolumeConfigTime, snapshotVolumeSize, isSnapshotConfiguration, isEventConfiguration, region, zone, isReturnProtection, nasVolumeInstanceCustomIpList, nasVolumeServerInstanceList);
	}
