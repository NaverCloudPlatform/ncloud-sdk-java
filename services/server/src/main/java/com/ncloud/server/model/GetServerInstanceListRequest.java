...
public class GetServerInstanceListRequest {
	...
	**/
	...
	@Override
	public int hashCode() {
		return Objects.hash(serverInstanceNoList, searchFilterName, searchFilterValue, pageNo, pageSize, serverInstanceStatusCode, regionNo, zoneNo, baseBlockStorageDiskTypeCode, baseBlockStorageDiskDetailTypeCode, sortedBy, sortingOrder, serverInstanceTypeCodeList, tagKeyList, tagValueList, responseFormatType);
	}
