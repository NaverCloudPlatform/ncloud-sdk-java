...
public class V2ApiTest {
	 ...
	 */
	@Test
	public void getMetricStatisticsGetTest() throws ApiException, SdkException {
		GetMetricStatisticsRequest getMetricStatisticsRequest = null;

		try {
			// Handler Successful response
			ApiResponse<GetMetricStatisticsResponse> response = api.getMetricStatisticsGet(getMetricStatisticsRequest);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getMetricStatisticsGetGenericTest() throws ApiException, SdkException {
		// path
		...
		try {
			// Handler Successful response
			ApiResponse<byte[]> response = api.getMetricStatisticsGet(httpHeaders, queryParams, formParams, requestBody);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getMetricStatisticsPostTest() throws ApiException, SdkException {
		GetMetricStatisticsRequest getMetricStatisticsRequest = null;

		try {
			// Handler Successful response
			ApiResponse<GetMetricStatisticsResponse> response = api.getMetricStatisticsPost(getMetricStatisticsRequest);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
	 ...
	 */
	@Test
	public void getMetricStatisticsPostGenericTest() throws ApiException, SdkException {
		// path
		...
		try {
			// Handler Successful response
			ApiResponse<byte[]> response = api.getMetricStatisticsPost(httpHeaders, queryParams, formParams, requestBody);
		} catch (ApiException e) {
			// Handler Failed response
			int statusCode = e.getHttpStatusCode();
			Map<String, List<String>> responseHeaders = e.getHttpHeaders();
